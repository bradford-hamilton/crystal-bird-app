...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Crystal Experiment web application."
  #
  #
  ...
  #
  # settings.secret_key_base= ZavaYH_AgDzVvSHY8uIJMmm5cSyXegXf1tu5bopWOyU
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("crystal-experiment.log", "w"))
  #
  #
end
